define('renderer/re-main', [], function () {
	return function () {
		var re = this;
		...
		return {
			...
			LoadMap: LoadMap,
			BuildSkyboxBuffers: BuildSkyboxBuffers,
			LoadLightmaps: LoadLightmaps,
			BuildWorldBuffers: BuildWorldBuffers,
			GenerateDrawSurfs: GenerateDrawSurfs,
			DrawWorld: DrawWorld
		};
	};
});