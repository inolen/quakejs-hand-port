        ...
        */
        create: {
            value: function(/* collected via arguments */) {
                ...
                var readFnCode =  "var Struct = this.Struct;"
                readFnCode += "var a = new Array(count);\n";
                ...
                var writeFnCode =  "var Struct = this.Struct;"
                writeFnCode += "var buffer = buffer || new ArrayBuffer(" + byteLength + ");\n";
                ...
                Object.defineProperty(struct, "deserialize", {
                    value: function () { return deserializeFn.apply(root, arguments); },
                    configurable: true,
                    writable: true
                });

                var serializeFn = new Function("buffer", "offset", writeFnCode);
                Object.defineProperty(struct, "serialize", {
                    value: function () { return serializeFn.apply(root, arguments); },
                    configurable: true,
                    writable: true
                });
