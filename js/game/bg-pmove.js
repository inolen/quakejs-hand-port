	...
	return function (q_shared) {
		...
		*/
		return {
			...
			ClipVelocity: function(velIn, normal) {
			...
			Accelerate: function(dir, speed, accel) {
			...
			StepSlideMove: function (gravity) {
			...
			UpdateViewAngles: function (ps, cmd) {
				for (var i = 0; i < 3; i++) {
