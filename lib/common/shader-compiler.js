...
ShaderCompiler.buildProgram = function (script, stages, numLights) {
	...
	if (script.name === 'textures/gothic_block/evil_e3bwindow') {
		console.log('textures/gothic_block/evil_e3bwindow', builder.getFragmentSource());
	}
