define('common/cvar', [], function () {
	...
	Cvar.prototype.getAsInt = function () {
		return asInt(this._getValue(), this._defaultValue);
	};

	Cvar.prototype.getAsFloat = function () {
		return asFloat(this._getValue(), this._defaultValue);
	};

	Cvar.prototype.getAsString = function () {
		return asString(this._getValue(), this._defaultValue);
	};
	...
	CvarCursor.prototype._getValue = function () {
	...
	CvarCursor.prototype.getAsInt = function () {
		return asInt(this._getValue(), this._cvar.getDefaultValue());
	};

	CvarCursor.prototype.getAsFloat = function () {
		return asFloat(this._getValue(), this._cvar.getDefaultValue());
	};

	CvarCursor.prototype.getAsString = function () {
		return asString(this._getValue(), this._cvar.getDefaultValue());
	};
