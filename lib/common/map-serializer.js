...
var MapBrush = function () {
	this.sides = null;
	this.patch = null;
};

var MapBrushSide = function () {
	this.plane        = null;
...
function LoadMap(mapName) {
	...
	console.log('Loading world for', mapName);

	var data = q3dm17buffer;//fs.readFileSync(mapName + '.map', 'utf8');
