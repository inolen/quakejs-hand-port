...
function CheckUserinfo() {
	...
	if (Cvar.cvarModifiedFlags & QS.CVF.USERINFO) {
		Cvar.cvarModifiedFlags &= ~QS.CVF.USERINFO;
		AddClientCommand('userinfo', Cvar.GetCvarsByFlag(QS.CVF.USERINFO));
	}
}
...
function CheckForResend() {
	...
	switch (clc.state) {
		...
		case CA.CHALLENGING:
			...
			var str = 'connect ' + JSON.stringify(Cvar.GetCvarsByFlag(QS.CVF.USERINFO));
