...
[
	...
	'common/qmath', 'common/qshared', 'cgame/cg', 'clipmap/cm', 'renderer/re', 'sound/snd', 'ui/ui'
],
function (_, async, glmatrix, ByteBuffer, QMath, QShared, cg_mod, cm_mod, re_mod, snd_mod, ui_mod) {
	function Client(imp) {
		var sys = imp.sys;
		var com = imp.com;
