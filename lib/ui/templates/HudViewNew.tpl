<div id="hud-new" data-bind="visible: visible">
		...
		<div class="scores">
			<!-- ko if: gametype() === 'team' || gametype() === 'ctf' || gametype() === 'nfctf' || gametype() === 'ca' -->
				<div class="score-wrapper score1 team-red" data-bind="css: { localplayer: score1.localplayer }">
					<span class="status"><span class="player" data-image="icons/player.png">&nbsp;</span> <span data-bind="text: score1.count"></span></span>
				...
				<div class="score-wrapper score2 team-blue" data-bind="css: { localplayer: score2.localplayer }">
					<span class="status"><span class="player" data-image="icons/player.png">&nbsp;</span> <span data-bind="text: score2.count"></span>
	...
	<div id="weapons-wrapper">
		<ul class="weapons" data-bind="foreach: weapons">
			...
			<li class="weapon" data-bind="css: { selected: $index === $parent.weaponSelect() }">
				<span class="icon" data-bind="attr: { 'data-himage': icon }"></span>
				<span class="ammo" data-bind="text: ammo"></span>
			</li>
			<!-- /ko -->
		</ul>
	</div>
