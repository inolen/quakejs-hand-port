 ...
 */
function InitImages() {
	uil.images = new AssetCache();
	uil.images.on('load', LoadImage);
...
function RegisterImage(name, callback) {
	...
	uil.images.load(name, callback);
}

/**
 * FindImageByHandle
 */
function FindImageByHandle(index) {
	return uil.images.findByHandle(index);
}
