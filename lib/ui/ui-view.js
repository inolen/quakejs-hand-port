...
function ScaleElements() {
	...
	for (var name in views) {
		...
		UpdateCenteredElements(views[name]);
		UpdateFontSizes(views[name]);
	}
}
 ...
 */
function UpdateCenteredElements(view) {
	var $centered = view.$el.find('.abscenter');
