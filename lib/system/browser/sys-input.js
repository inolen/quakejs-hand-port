...
function KeyDownEvent(ev) {
	...
	com.QueueEvent({ type: QS.SE.KEY, pressed: true, keyName: keyName });
}
...
function KeyUpEvent(ev) {
	...
	com.QueueEvent({ type: QS.SE.KEY, pressed: false, keyName: keyName });
}
...
function MouseMoveEvent(ev) {
	...
	com.QueueEvent({ type: QS.SE.MOUSE, deltaX: deltaX, deltaY: deltaY });
}
