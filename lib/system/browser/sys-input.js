...
function KeyDownEvent(ev) {
	...
	COM.QueueEvent({ type: COM.SE.KEY, pressed: true, keyName: keyName });
}
...
function KeyUpEvent(ev) {
	...
	COM.QueueEvent({ type: COM.SE.KEY, pressed: false, keyName: keyName });
}
...
function MouseMoveEvent(ev) {
	...
	COM.QueueEvent({ type: COM.SE.MOUSE, deltaX: deltaX, deltaY: deltaY });
}
