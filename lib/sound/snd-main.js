...
function Init(callback) {
	...
	snd.volume_main.gain.value = s_gain.get();
	...
	snd.volume_music.gain.value = s_musicVolume.get();
...
function Frame() {
	...
	if (s_volume.modified()) {
		snd.volume_main.gain.value = s_volume.get();
	}
...
function StartSound(origin, entityNum, hSound, looping) {
	...
	panner.connect(snd.volume_main);
...
function StartLocalSound(hSound, looping) {
	...
	bufsrc.connect(snd.volume_main);
