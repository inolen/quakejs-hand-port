...
var ArenaInfo = function () {
	...
	this.gametype               = 0;
	this.state                  = null;
	this.teams                  = new Array(MAX_CLIENTS);
	this.warmupTime             = 0;
	this.restartTime            = 0;
	this.team1                  = TEAM.NONE;
	this.team2                  = TEAM.NONE;
	this.lastWinningTeam        = TEAM.NONE;
