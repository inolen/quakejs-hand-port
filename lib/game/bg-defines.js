...
var MASK = {
	ALL:         -1,
	SOLID:       QS.CONTENTS.SOLID,
	PLAYERSOLID: QS.CONTENTS.SOLID | QS.CONTENTS.PLAYERCLIP | QS.CONTENTS.BODY,
	DEADSOLID:   QS.CONTENTS.SOLID | QS.CONTENTS.PLAYERCLIP,
	WATER:       QS.CONTENTS.WATER | QS.CONTENTS.LAVA | QS.CONTENTS.SLIME,
	OPAQUE:      QS.CONTENTS.SOLID | QS.CONTENTS.SLIME | QS.CONTENTS.LAVA,
	SHOT:        QS.CONTENTS.SOLID | QS.CONTENTS.BODY | QS.CONTENTS.CORPSE
};
...
TeamNames[TEAM.SPECTATOR] = 'SPECTATOR';