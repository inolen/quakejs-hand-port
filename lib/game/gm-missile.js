...
function RunMissile(ent) {
	...
	var tr = sv.Trace(ent.r.currentOrigin, origin, ent.r.mins, ent.r.maxs, ent.r.ownerNum, ent.clipmask);
	if (tr.startSolid || tr.allSolid) {
		// Make sure the tr.entityNum is set to the entity we're stuck in.
		tr = sv.Trace(ent.r.currentOrigin, ent.r.currentOrigin, ent.r.mins, ent.r.maxs, ent.r.ownerNum, ent.clipmask);
		tr.fraction = 0;
	} else {
