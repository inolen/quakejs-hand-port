...
function FireGrenade (self, start, dir) {
	...
	bolt.s.weapon = WP.GRENADE_LAUNCHER;
	bolt.s.eFlags = EF.BOUNCE_HALF;
	bolt.ownerNum = self.s.number;
	bolt.parent = self;
	bolt.damage = 100;
	bolt.splashDamage = 100;
	bolt.splashRadius = 150;
	bolt.methodOfDeath = MOD.GRENADE;
	bolt.splashMethodOfDeath = MOD.GRENADE_SPLASH;
	bolt.clipmask = MASK.SHOT;
// 	bolt.target_ent = null;
	
	bolt.s.pos.trType = TR.GRAVITY;
