...
function PickTeam(ignoreClientNum) {
	...
	if ((g_gametype.getAsInt() === GT.CLANARENA && playersPerTeam && ArenaCount(ignoreClientNum) >= playersPerTeam*2) ||
	    (g_gametype.getAsInt() === GT.TOURNAMENT && level.arena.numNonSpectatorClients >= 2)) {
		log('OVERFLOW');
		team = TEAM.SPECTATOR;
	}
