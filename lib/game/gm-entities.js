...
var fields = {
	...
	'model':      { },
	'model2':     { },
	'origin':     { type: 'vector', aliases: ['r.currentOrigin', 's.origin', 's.pos.trBase'] },
	'random':     { type: 'float' },
	'spawnflags': { type: 'int' },
	'speed':      { type: 'float' },
	'target':     { },
 ...
 * SpawnEntityFromDef
 */
function SpawnEntityFromDef(def, arenaNum) {
	var ent = SpawnEntity(arenaNum);
 ...
 */
function TempEntity(arenaNum, origin, event) {
	var e = SpawnEntity(arenaNum);
