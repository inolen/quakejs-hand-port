...
function RegisterCvars() {
	// Latched vars.
	g_gametype           = Cvar.AddCvar('g_gametype',           0,     CVAR.SERVERINFO | CVAR.LATCH);
	g_arenas             = Cvar.AddCvar('g_arenas',             '',    CVAR.SERVERINFO | CVAR.LATCH);

	// Change anytime vars.
	g_fraglimit          = Cvar.AddCvar('g_fraglimit',          20,    CVAR.SERVERINFO | CVAR.ARCHIVE | CVAR.NORESTART);
	g_timelimit          = Cvar.AddCvar('g_timelimit',          0,     CVAR.SERVERINFO | CVAR.ARCHIVE | CVAR.NORESTART);
	g_capturelimit       = Cvar.AddCvar('g_capturelimit',       8,     CVAR.SERVERINFO | CVAR.ARCHIVE | CVAR.NORESTART);
