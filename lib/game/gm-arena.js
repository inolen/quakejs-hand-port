 ...
 * InitArenas
 *
 * Initializes a single default arena, as well as one per
 * unique arena index in each info_player_intermission.
 */
function InitArenas() {
	...
	for (var i = 0; i < points.length; i++) {
		...
		level.arenas[arenaNum] = new ArenaLocals();
	}
}
