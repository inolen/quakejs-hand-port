...
// 		ChangeGameState(GS.WAITING);
// 		return;
// 	}

// 	if (level.arena.gamestate > GS.COUNTDOWN) {
// 		return;
// 	}
...
// 	if (level.arena.gamestate === GS.WAITING) {
// 		if (level.arena.numPlayingClients === 2) {
...
// 			ChangeGameState(GS.COUNTDOWN);
// 		}
// 	}
// 	// If the warmup time has counted down, restart.
// 	else if (level.arena.gamestate === GS.COUNTDOWN && level.time > level.arena.warmupTime) {
