...
define('renderer/re',
['underscore', 'jquery', 'glmatrix', 'ByteBuffer', 'common/bsp-serializer', 'common/text-tokenizer', 'common/qmath', 'common/qshared'],
function (_, $, glmatrix, ByteBuffer, BspSerializer, TextTokenizer, QMath, QShared) {
