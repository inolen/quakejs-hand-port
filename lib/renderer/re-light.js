...
function SetupEntityLightingGrid(refent) {
	...
	// 0 out old values.
	refent.ambientLight[0] = refent.ambientLight[1] = refent.ambientLight[2] = 0.0;
	refent.directedLight[0] = refent.directedLight[1] = refent.directedLight[2] = 0.0;
	...
	vec3.scale(refent.ambientLight, r_ambientScale.get());
	vec3.scale(refent.directedLight, r_directedScale.get());
