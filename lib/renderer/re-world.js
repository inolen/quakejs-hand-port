...
function ShaderForShaderNum(shaderNum, lightmapNum) {
	...
	// // FIXME maps don't export shaders yet.
	// if (!shaders) {
...
// 		var xyz        = geo.xyz        = CreateBuffer('float32', 3, group.numVerts);
// 		var normal     = geo.normal     = CreateBuffer('float32', 3, group.numVerts);
// 		var texCoord   = geo.texCoord   = CreateBuffer('float32', 2, group.numVerts);
// 		var lightCoord = geo.lightCoord = CreateBuffer('float32', 2, group.numVerts);
// 		var color      = geo.color      = CreateBuffer('uint8',   4, group.numVerts);
// 		var index      = geo.index      = CreateBuffer('uint16',  1, group.numIndexes, true);
...
// 			TessellateFace(group.faces[j]);
// 		}
// 		geo.indexOffset = offset;
// 		geo.indexCount = index.elementCount - offset;

// 		geo.updateXyz = false;
// 		geo.updateNormal = false;
// 		geo.updateTexCoord = false;
// 		geo.updateLightCoord = false;
// 		geo.updateColor = false;
// 		geo.updateIndex = false;
// 	}
