...
function CreateDefaultShader() {
	...
	var stage = new ShaderScriptStage();
...
function CreateDebugShader() {
	...
	shader.name = '<debug>';
	shader.cull = null;
	shader.program = CompileShaderProgram(vs, fs);
 ...
 */
function CreateShaderFromTexture(shaderName, lightmapIndex) {
	var script = new ShaderScript();
