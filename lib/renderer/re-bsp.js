...
function LoadWorld(world, callback) {
	var reworld = re.world = new RenderWorld();

	// The renderer just needs to store a reference to the
	// original data for the most part.
	reworld.shaders = world.shaders;
	reworld.numClusters = world.numClusters;
	reworld.clusterBytes = world.clusterBytes;
	reworld.vis = world.vis;

	// Process certain data into more appropriate structures.
	LoadNodesAndLeafs(reworld, world.nodes, world.leafs, world.leafSurfaces, world.planes);
	LoadBrushModels(reworld, world.bmodels);
	LoadSurfaces(reworld, world.surfaces, world.verts, world.indexes);
	LoadLightmaps(reworld, world.lightmaps);
	LoadLightGrid(reworld,
 ...
 * LoadNodesAndLeafs
 */
function LoadNodesAndLeafs(world, nodes, leafs, leafSurfaces, planes) {
 ...
 * LoadSurfaces
 */
function LoadSurfaces(world, surfaces, verts, meshVerts) {
	world.verts = verts;
 ...
 * LoadBrushModels
 */
function LoadBrushModels(world, models) {
 ...
 * LoadLightmaps
 */
function LoadLightmaps(world, buffer) {
 ...
 * LoadLightGrid
 */
function LoadLightGrid(world, lightGridOrigin, lightGridSize, lightGridInverseSize, lightGridBounds, lightGridData) {
