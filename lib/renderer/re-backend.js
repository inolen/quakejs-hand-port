...
function EndSurface() {
	...
	re.counts.shaders++;
	re.counts.vertexes += tess.xyz.elementCount;
...
function DrawTris() {
	...
	// This is slow as can be, but it does the job. It'd be nice if WebGL
	// supported proper wireframes.
	for (var i = 0; i < tess.index.elementCount; i += 3) {
