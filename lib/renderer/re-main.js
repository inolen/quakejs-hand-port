...
function RenderView(parms) {
	...
	// 	var shader = sortedShaders[(geo.sort >> QSORT_SHADERNUM_SHIFT) % MAX_SHADERS];
	// 	var entityNum = (geo.sort >> QSORT_ENTITYNUM_SHIFT) % MAX_GENTITIES;
	...
	// 	if (MirrorViewBySurface(geo, entityNum)) {
