...
function SetupProjectionMatrixZ() {
	...
	parms.projectionMatrix[10] = PROJECTION_Z_EPSILON - (zFar + zNear) / depth;
	parms.projectionMatrix[14] = (PROJECTION_Z_EPSILON - 2) * zFar * zNear / depth;
}
