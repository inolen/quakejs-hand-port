...
WorldGeometry.prototype = new BufferGeometry();
WorldGeometry.prototype.constructor = WorldGeometry;

var SkydomeGeometry = function () {
};
SkydomeGeometry.prototype = new BufferGeometry();
...
Md3Geometry.prototype = new BufferGeometry();
Md3Geometry.prototype.constructor = SkydomeGeometry;

var EntityGeometry = function () {
};
EntityGeometry.prototype = new BufferGeometry();
...
var LIGHTMAP = {
	LIGHTGRID: -2,
	VERTEX:    -1,                                         // pre-lit triangle models,
	                                                       // bsp model surfaces have this hardcoded
};
 ...
 * Skins
 *
 * Allow models to be retextured without modifying the
 * model file.
 *********************************************************/
var Skin = function () {
	this.name     = null;
