...
var MAX_DLIGHTS    = 32;  // can't be increased, because bit flags are used on surfaces
...
var BackendState = function () {
	...
	// Dlight buffers, refreshed once per view.
	this.dlightPos          = new Float32Array(MAX_DLIGHTS * 4);
	this.dlightColor        = new Float32Array(MAX_DLIGHTS * 4);
...
var ShaderScriptStage = function () {
	this.maps             = [];
	this.animFreq         = 0;
	this.clamp            = false;
	this.tcGen            = 'base';
