...
var SS = {
	...
	OPAQUE:         2,                                     // opaque
	DECAL:          3,                                     // scorch marks, etc.
	SEE_THROUGH:    4,                                     // ladders, grates, grills that may have small blended
	                                                       // edges in addition to alpha test
	BANNER:         5,
	FOG:            6,
	UNDERWATER:     7,                                     // for items that should be drawn in front of the water plane
	BLEND0:         8,                                     // regular transparency and filters
	BLEND1:         9,                                     // generally only used for additive type effects
	BLEND2:         10,
	BLEND3:         11,
	BLEND6:         12,
	STENCIL_SHADOW: 13,
	ALMOST_NEAREST: 14,                                    // gun smoke puffs
	NEAREST:        15,                                    // blood blobs
	ENVIRONMENT:    16                                     // sky box
};
