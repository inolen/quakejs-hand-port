...
var QSORT_ENTITYNUM_SHIFT = QS.GENTITYNUM_BITS;
var QSORT_SHADERNUM_SHIFT = QSORT_ENTITYNUM_SHIFT + QS.GENTITYNUM_BITS;
...
var RenderLocals = function () {
	...
	this.or                 = new QS.Orientation();           // for current entity
...
var ViewParms = function () {
	this.or               = new QS.Orientation();
	// this.world            = new QS.Orientation();
...
var BackendState = function () {
	...
	this.refents         = new Array(QS.MAX_GENTITIES);
...
var ShaderStage = function () {
	...
	this.textures   = [];                                  // 2d array of textures
	this.animFreq   = [];                                  // 2d array of animation info
};
