...
var RenderLocals = function () {
	...
	this.programs           = {};                          // GLSL programs compiled from shader scripts
	this.shaders            = null;
	this.sortedShaders      = [];
...
var BackendState = function () {
	...
	this.dlightPositions = new Float32Array(MAX_DLIGHTS * 4);
...
var Shader = function () {
	...
	this.positionLerp   = false;                           // add positional lerp
...
// These flags accompany a script to declare additional
// parameters for the shader compiler.
var SF = {
	LIGHTMAP_VERTEX: 1,
	LIGHTMAP_GRID:   2,
	POSITION_LERP:   4
