...
function InitMenus() {
	...
	var ingame_model = new UI.TabModel();
	ingame_model.title('ingame');
	ingame_model.addTab('Current game', currentgame_model, UI.CurrentGameTemplate);
	ingame_model.addTab('Settings', settings_model, UI.SettingsTemplate);

	ingame_view = UI.CreateView(ingame_model, UI.TabTemplate);
}
