...
define('cgame/cg',
['underscore', 'glmatrix', 'common/qmath', 'common/text-tokenizer', 'common/qshared', 'common/cvar', 'common/object-pool', 'game/bg'],
function (_, glmatrix, QMath, TextTokenizer, QShared, Cvar, ObjectPool, BG) {
	function CGame(imp) {
		var sys = imp.sys;
		var com = imp.com;
		var cl  = imp.cl;
