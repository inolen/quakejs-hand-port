...
function RegisterWeapon(gitem) {
	...
	// 		cgs.media.railRingsShader = trap_R_RegisterShader( "railDisc" );
			cgs.media.plasmaExpSfx = imp.snd_RegisterSound('sound/weapons/plasma/plasmx1a');
			break;
	...
	// 		MAKERGB( weaponInfo.flashDlightColor, 1, 0.5f, 0 );
			...
			cgs.media.railExplosionShader = imp.re_RegisterShader('railExplosion');
			cgs.media.railRingsShader = imp.re_RegisterShader('railDisc');
			cgs.media.railCoreShader = imp.re_RegisterShader('railCore');
			break;
...
function RailTrail(ci, start, end) {
	...
	re.shaderTime = cg.time / 1000;
	re.reType = RT.RAIL_CORE;
	re.customShader = cgs.media.railCoreShader;

	vec3.set(start, re.origin);
	vec3.set(end, re.oldOrigin);

	re.shaderRGBA[0] = 1/*ci.color1[0]*/ * 255;
	re.shaderRGBA[1] = 0/*ci.color1[1]*/ * 255;
	re.shaderRGBA[2] = 0/*ci.color1[2]*/ * 255;
	re.shaderRGBA[3] = 255;
