...
//			AddLoopingSound( cent.currentState.number, cent.lerpOrigin, vec3origin, weapon.firingSound );
			cent.pe.lightningFiring = true;
		} else if (weapon.readySound) {
//			AddLoopingSound( cent.currentState.number, cent.lerpOrigin, vec3origin, weapon.readySound );
		}
	}
