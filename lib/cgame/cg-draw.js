...
function HudUpdateScores() {
	...
	if (cgs.gametype >= GT.TEAM) {
		...
		info2 = { score: arena.score1, count: arena.count2, localplayer: ci.team === TEAM.BLUE };
	} else {
		...
		if (!i1.localplayer) {
			...
			info2 = { rank: rank, name: ci2.name, score: info2.score, localplayer: false };
		}
	}
...
function IngameUpdateArenas() {
	...
	view_ingame.setCurrentArena(cg.snap.ps.arenaNum);
