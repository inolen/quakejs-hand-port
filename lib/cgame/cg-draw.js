...
function HudUpdateScores() {
	...
	if (cgs.gametype >= GT.TEAM) {
		...
		// 	}
		// }
		info1 = { score: arena.score1, count: arena.num1, localplayer: ci.team === TEAM.RED };
		info2 = { score: arena.score2, count: arena.num2, localplayer: ci.team === TEAM.BLUE };
	} else {
		var ci1 = cgs.clientinfo[score1.num];
		var ci2 = arena.score2 !== SCORE_NOT_PRESENT ? cgs.clientinfo[score2.num] : null;
