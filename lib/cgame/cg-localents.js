...
// 	CG_Trace( &trace, le.refEntity.origin, NULL, NULL, newOrigin, -1, CONTENTS.SOLID );
...
// 	// and floating levels
// 	if ( CG_PointContents( trace.endPos, 0 ) & CONTENTS.NODROP ) {
...
function AddScaleFade(le) {
	...
	refent.shaderRGBA[3] = 0xff * c * le.color[3];
	refent.radius = le.radius * (1.0 - c) + 8;
