...
// 	exp.RE_shaderRGBA[0] = 0xff;
// 	exp.RE_shaderRGBA[1] = 0xff;
// 	exp.RE_shaderRGBA[2] = 0xff;
// 	exp.RE_shaderRGBA[3] = 0xff * c * 0.33;

// 	exp.RE_reType = RT_SPRITE;
// 	exp.RE_radius = 42 * ( 1.0 - c ) + 30;
...
// 		trap_R_AddLightToScene(exp.RE_origin, light, le->lightColor[0], le->lightColor[1], le->lightColor[2] );
// 	}
// }
