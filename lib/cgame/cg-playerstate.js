...
function UpdateArenaInfo() {
	// Open ingame menu if spectating after an arena change.
	if (cgs.gametype >= GT.TEAM && cg.snap.ps.persistant[PERS.TEAM] === TEAM.SPECTATOR && lastArena !== cg.snap.ps.arenaNum) {
		HandleEscape();
	}
