...
function UpdateArenaInfo() {
	// Open ingame menu on arena change.
	log('UpdateArenaInfo', cgs.gametype, GT.CLANARENA, typeof(cgs.gametype), lastArena, cg.snap.ps.arenaNum);

	if (cgs.gametype === GT.CLANARENA && lastArena !== cg.snap.ps.arenaNum) {
		HandleEscape();
	}
