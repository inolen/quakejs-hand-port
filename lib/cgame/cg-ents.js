...
function AddMissile(cent) {
	...
	switch (es.weapon) {
		...
		case WP.ROCKET_LAUNCHER:
			...
			missileDlight = 200;
			missileDlightColor[0] = 1.0;
			missileDlightColor[1] = 0.75;
			missileDlightColor[2] = 0.0;
			break;
	...
	// Add dynamic light.
	if (missileDlight) {
		re.AddLightToScene(cent.lerpOrigin, missileDlight, missileDlightColor[0], missileDlightColor[1], missileDlightColor[2]);
	}
