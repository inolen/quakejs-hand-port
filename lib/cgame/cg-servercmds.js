...
function ParseServerinfo() {
	...
	cgs.rocketarena = serverInfo['g_rocketarena'];
	...
	currentgame_model.rocketarena(cgs.rocketarena);
...
function ParseTeamInfo(teamNum) {
	var info = Configstring('team' + teamNum);

	var arena = cgs.arenas[info.ar];
