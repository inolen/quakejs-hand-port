...
function ParseWarmup() {
	var warmup = ConfigString('warmup');

	console.log('ParseWarmup', warmup);
...
function ParseScores(val) {
	// FIXME why do we need this if we have cgs.score1 and cgs.score2?
	...
	view_scoreboard.setTeamScores(cg.teamScoreRed, cg.teamScoreBlue);
